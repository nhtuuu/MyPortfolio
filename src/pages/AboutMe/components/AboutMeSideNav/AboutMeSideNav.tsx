  ...
  return (
    <div>
      <div className='flex items-center p-4 border-b border-borderColor'>
        ...
        <span className='ml-2 text-textSecondaryColor'>personal-info</span>
      </div>
      <ul className='p-4'>
        <li className='flex mb-2'>
          <svg width='9' height='14' viewBox='0 0 9 14' fill='none' xmlns='http://www.w3.org/2000/svg' className='mr-2'>
            <path
          ...
          <span
            className={classNames('ml-2', {
              'text-textSecondaryColor': pathname === path.about || pathname === path.bio
            })}
          >
            bio
          </span>
      ...
      <div className='flex items-center p-4 border-t border-b border-borderColor'>
        ...
        <span className='ml-2 text-textSecondaryColor'>contacts</span>
      </div>
      <ul className='p-4'>
        <li className='flex mb-2'>
